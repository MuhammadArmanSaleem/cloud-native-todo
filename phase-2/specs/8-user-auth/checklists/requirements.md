# Specification Quality Checklist: User Authentication UI (Login/Signup)
...
- Scope clearly excludes password reset, email verification, social auth, and advanced features
